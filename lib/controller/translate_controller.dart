...
import 'package:my_assistant/controller/image_controller.dart';
import 'package:my_assistant/openai_services.dart';
import 'package:my_assistant/widgets/my_dialog.dart';
...
class TranslateController extends GetxController {
  ...
  Future<void> translate() async {
    //translate field box and language translate to should not be empty
    if (textC.text.trim().isNotEmpty && to.isNotEmpty) {
      ...
      final res = await openAIService.chatGPTAPI(prompt);
